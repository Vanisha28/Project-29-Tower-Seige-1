...
function setup()
{
  ...
  world = engine.world;
  ground1 = new Ground(435,265,300,20);
  ...
  block16 = new Box(480,195,30,40);
  block17 = new Box(860,120,30,40);
  block18 = new Box(830,120,30,40);
  block19 = new Box(800,120,30,40);
  block20 = new Box(510,195,30,40);

  //Level two
  block21 = new Box(420,155,30,40);
  block22 = new Box(450,155,30,40);
  block23 = new Box(480,155,30,40)
  block24 = new Box(830,80,30,40);

  //Top
  block25 = new Box(450,100,30,40);
